...
class SafeWaterGuideScreen extends StatelessWidget {
  const SafeWaterGuideScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Safe Water Guide',
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('Water Safety Resources',
                          style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: primaryColor)),
                      Text('Guides to prevent CKD through safe water',
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('No guides available yet', style: TextStyle(fontSize: 16, color: Colors.grey.shade500)),
                      ],
                    ),
                  );
                }
                            ...
                            ClipRRect(
                              ...
                              child: Image.network(
                                ...
                                errorBuilder: (_, __, ___) => Container(
                                  ...
                                  child: const Center(child: Icon(Icons.water_drop, color: Colors.blue, size: 32)),
                                ),
                              ),
                            )
                          else
