...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _pickAndUploadPdf() async {
    try {
      ...
      if (response.statusCode != 200) {
        _showSnackBar("API Error ${response.statusCode}: ${response.reasonPhrase}");
        return;
      }
        ...
        content: Column(
          ...
          children: [
            ...
            if (fieldsFound > 0) ...[
              ...
              Text("Found $fieldsFound field(s) — need at least 3.",
  ...
  Widget _buildLabValueRow(String key, dynamic value, {bool isLast = false}) {
    ...
    if (isNull) {
      ...
      displayValue = unit.isNotEmpty ? "$value $unit" : value.toString();
    }
